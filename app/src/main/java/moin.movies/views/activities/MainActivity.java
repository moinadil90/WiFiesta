...
public class MainActivity extends AppCompatActivity implements FragmentManager.OnBackStackChangedListener,
    ...
    private void checkFirstRun() {
        if (sharedPreferences.getBoolean(Constants.firstRun, true)) {
            TapTargetViewHelper tapTargetViewHelper = new TapTargetViewHelper(this);
            tapTargetViewHelper.showTutorial();
            sharedPreferences.edit().putBoolean(Constants.firstRun, false).apply();
        }
    }
    ...
    public void OnNetworkChanged(int status) {
        ...
        Log.d("TESTE", "OnNetworkChanged: " + status);
    }
}
